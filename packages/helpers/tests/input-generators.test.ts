...
describe('JWT Input Generators', () => {
  ...
  beforeAll(() => {
    ...
    validAccountCode = BigInt('0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef');
  });

  describe('generateJWTVerifierInputs', () => {
    it('should generate valid base inputs for JWT verification', async () => {
      const result = await generateJWTVerifierInputs(validJWT, validPublicKey);
  ...
  describe('generateJWTAuthenticatorInputs', () => {
    it('should generate valid inputs for JWT authentication', async () => {
      const result = await generateJWTAuthenticatorInputs(validJWT, validPublicKey, validAccountCode);
  ...
  describe('generateJWTAuthenticatorWithAnonDomainsInputs', () => {
    it('should generate valid inputs with anonymous domains', async () => {
      const result = await generateJWTAuthenticatorWithAnonDomainsInputs(validJWT, validPublicKey, validAccountCode, {
        anonymousDomainsTreeHeight: 2,
        anonymousDomainsTreeRoot: BigInt('0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef'),
        emailDomainPath: [BigInt('0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef')],
